...
GamePlayScene::GamePlayScene()
{
	...
	gameObjects.push_back(GameObjectFactory::createPowerUp("heal", 500, 500));
	gameObjects.push_back(GameObjectFactory::createPowerUp("speed", 600, 600));
...
void GamePlayScene::update(float deltaTime)
{
	...
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::L)) {
		GameManager::getInstance().setScene(std::make_shared<LevelUpScene>());
	}
